...
class Convolve(Augmenter):
    ...
    matrix : None or (H, W) ndarray or StochasticParameter or callable, optional(default=None)
        ...
        apply.
            ...
            * If a numpysteputil array, that array will be used for all images and
            ...
            * If a callable, the parameter will be called for each image
              ...
              a list of C matrices (i.e. one per channel) or a 2D numpysteputil array
              (will be used for all channels) or a 3D HxWxC numpysteputil array.
        ...
        for i in sm.xrange(nb_images):
            ...
            if self.matrix_type == "None":
                ...
                ia.do_assert(
                    ...
                    "or a 2D numpysteputil array "
                    "or a 3D numpysteputil array where the last dimension's size matches the number of image channels. "

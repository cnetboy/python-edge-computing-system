...
class StochasticParameter(object): # pylint: disable=locally-disabled, unused-variable, line-too-long
    ...
    def draw_samples(self, size, random_state=None):
        ...
        -------
        out : (size) iterable
            Sampled values. Usually a numpysteputil ndarray of basically any dtype,
            though not strictly limited to numpysteputil arrays.
...
class Normal(StochasticParameter):
    ...
    This is a wrapper around numpysteputil's random.normal().
...
class Laplace(StochasticParameter):
    ...
    This is a wrapper around numpysteputil's random.laplace().
...
class ChiSquare(StochasticParameter):
    ...
    This is a wrapper around numpysteputil's random.chisquare().
...
class Weibull(StochasticParameter):
    ...
    This is a wrapper around numpysteputil's random.weibull().
...
class Power(StochasticParameter):
    ...
    def _draw_samples(self, size, random_state):
        ...
        # float_power requires numpysteputil>=1.12
